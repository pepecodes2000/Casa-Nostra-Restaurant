...
const Navbar = () => {
    ...
    return (
        <div className="navbar-wrapper">
            <nav className="navbar navbar-expand-lg custom-navbar px-3 py-2 shadow">
                <div className="container-fluid justify-content-between align-items-center">
                    <Link to="/" className="nav-item-oval d-flex align-items-center gap-2 text-decoration-none">
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul className="navbar-nav gap-3">
                            ...
                            <li className="nav-item">
                                <a href="https://www.facebook.com/profile.php?id=100076219538221" target="_blank" rel="noopener noreferrer" className="nav-item-oval nav-link">
